...
<head>
  ...
  <title>GesClientèle/liste villages</title>
  <!-- Font Awesome -->
            ...
            <div class="row mt-2">
                <div class="card col-md-12">
                    <div class="card-header text-primary">
                        <h4 class="text-center"><strong>Liste des villages</strong></h4>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><h6>ID</h6></th>
                                    <th><h6>Nom village</h6></th>
                                    <th><h6>Chef du village</h6></th>
                                    <th><h6>Enregistrer par</h6></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($data as $village) { ?>
                                    <tr>
                                        <td><?= $village->getIdVillage() ?></td>
                                        <td><?= $village->getNomVillage() ?></td>
                                        <td><?= $village->getChefVillage() ?></td>
                                        <td><?= $village->getIdUserF()->getPrenomUser().' '.$village->getIdUserF()->getNomUser() ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>

            ...
            <div class="row mt-2">
                <div class="card col-md-12">
                    <div class="card-header text-primary">
                        <h4 class="text-center"><strong>Liste des clients</strong></h4>
                    </div>
                            ...
                            <tbody>
                              <?php foreach($data as $client) { ?>
                                  <tr>
                                      ...
                                      <td><?= $client->getTelClient() ?></td>
                                      <td><?= $client->getIdVillageF()->getNomVillage() ?></td>
                                      <td><?= $client->getIdUserF()->getPrenomUser().' '.$client->getIdUserF()->getNomUser() ?></td>
                                  </tr>
                              <?php } ?>  
                            </tbody>
                        </table>

...
<head>
  ...
  <title>GesClientèle/ajout client</title>
  <!-- Font Awesome -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header text-primary">
                    <h5 class="text-center"><strong>Formulaire d'ajout d'un client</strong></h5>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= $url ?>/Client/addClient" class="form-group">

                        <div class="row mt-4">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Entrer Le nom complet du client" name="nom">
                            </div>
                        </div>

                        <div class="row mt-4">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Entrer l'adresse du client" name="adresse">
                            </div>
                        </div>

                        <div class="row mt-4">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Entrer le numéro de téléphone du client" name="tel">
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <select class="form-control" name="village" required>
                                    <?php foreach($data[1] as $village) { ?>
                                        <option value="<?= $village->getIdVillage() ?>"><?=$village->getNomVillage()?></option>
                                    <?php } ?> 
                                </select>
                            </div>
                        </div>
